...
def about():
    if request.method=='POST':
        ...
        if 'code' in request.form.keys():
            ...
            f.save('C:/Users/V.Bhat/Desktop/Graduate Studies/Co-Corriculars/Projects/Cool-Flask-Stuff/static/user_files'+full_name)
            url[request.form['name']]={'file':full_name}
